    ...
    <section className="section-full" style={{ background: "var(--bg)" }}>
      <div className="container">
        <motion.div
          ...
          className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-0 divide-x-0 md:divide-x divide-[var(--divider)]"
        >
          {stats.map((stat) => (
            <motion.div
              key={stat.label}
            ...
            >
              <span
                className="heading-sm mb-2 transition-colors duration-300"
                style={{
